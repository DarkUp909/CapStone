-- setting the last_sold_date_sk and delete it to make sure to get the latest sales
set last_sold_wk_sk = (select max(sold_wk_sk) from TPCDS.ANALYTICS.WEEKLY_SALES);
